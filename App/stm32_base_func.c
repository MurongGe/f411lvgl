...
/**
 ******************************************************************************
 * @file           : stm32f103_base_func.c
 * @brief          : f103 base function (delay, printf, uart, uart_data, uart_cmd)
 ******************************************************************************
 * @attention
 *
 * Copyright (c) 2023 Zhou.
 * All rights reserved.
 *
...
void delay_us(uint32_t nus)
{
  ...
  ticks = nus * (SystemCoreClock/1000000);    /* 需要的节拍数, 100个tick一微秒 */
